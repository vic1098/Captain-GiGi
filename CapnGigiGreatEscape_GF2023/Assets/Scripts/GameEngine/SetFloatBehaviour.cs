...
public class SetFloatBehaviour : StateMachineBehaviour
{
    ...
    // OnStateMachineEnter is called when entering a state machine via his Entry Node
    ...
    // OnStateMachineExit is called when exiting a state machine via his Exit Node
